...
const supabase = createClient("https://gtlobmekbicbhkctqaky.supabase.co", "sb_secret_VnysgCOq1-gJXlGHlAmOTg_9-Vkgunx");
...
export async function readBucket() {
    ...
    const url = "https://gtlobmekbicbhkctqaky.supabase.co/storage/v1/object/public/doikayt_cache/" +
        name;
